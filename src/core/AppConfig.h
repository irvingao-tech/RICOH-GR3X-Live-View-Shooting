...
struct AppConfig {
    ...
    struct RicohPower {
        static constexpr const char* kPowerStateUuid = RICOH_BLE_POWER_STATE_UUID;
        static constexpr uint8_t kPowerStateOnValue = RICOH_BLE_GR3_POWER_STATE_ON_VALUE;
        static constexpr uint8_t kPowerStateOffValue = RICOH_BLE_GR3_POWER_STATE_OFF_VALUE;
